<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="subscriptiondata.aspx.cs" Inherits="ipoandsmedetails.susbcriptiondata" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ipo And Sme Subscription</title>
      <style>
        h1{
            color:black;
            align-items:center;
 ...
 <li><a href="gmpdata.aspx">Ipo And Sme Gmp</a></li>
  ...
  <li><a href="admin.aspx">Admin</a></li>
    ...
    <form id="form1" runat="server">
          <h1>Ipo And Sme Subscription</h1>
