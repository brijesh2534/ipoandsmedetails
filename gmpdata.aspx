<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gmpdata.aspx.cs" Inherits="ipoandsmedetails.gmpdata" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Ipo  And Sme Gmp</title>
     <style>
        h1{
            color:black;
            align-items:center;
...
<body>
  ...
  <li><a href="admin.aspx">Admin</a></li>
    ...
    <form id="form1" runat="server">
          <h1>Ipo And Sme Gray Market Premium</h1>
